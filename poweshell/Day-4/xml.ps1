...
#calling the data
[xml]$xmldata = Get-Content "C:\poweshell\Day-4\books.xml"
...
$xmldata.catalog.book | Where-Object { $_.genre -match "fant" } | Select-Object id,title

$xmldata.catalog.book | Where-Object { $_.title -like "xml*" } | Select-Object id,title

$xmldata.catalog.book | Where-Object { $_.genre -ne "Fantasy" } | Select-Object id,title
